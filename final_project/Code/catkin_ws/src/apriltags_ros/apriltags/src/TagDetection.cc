...
Eigen::Matrix4d TagDetection::getRelativeTransform(double tag_size, double fx, double fy, double px, double py) const {
	return getRelativeTransform(tag_size, fx, fy, px, py, 0.0, 0.0);
}

Eigen::Matrix4d TagDetection::getRelativeTransform(double tag_size, double fx, double fy, double px, double py, double offset_x, double offset_y) const {
  ...
  std::pair<double, double> p1( p[0].first+offset_x, p[0].second+offset_y );
  std::pair<double, double> p2( p[1].first+offset_x, p[1].second+offset_y );
  std::pair<double, double> p3( p[2].first+offset_x, p[2].second+offset_y );
  std::pair<double, double> p4( p[3].first+offset_x, p[3].second+offset_y );
